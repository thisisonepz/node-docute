...
const random_list=[/*'https://unpkg.com/live2d-widget-model-hibiki@1.0.5/assets/hibiki.model.json',*//*'https://unpkg.com/live2d-widget-model-miku@1.0.5/assets/miku.model.json',*/'https://unpkg.com/live2d-widget-model-shizuku@1.0.5/assets/shizuku.model.json']
const random_path=random_list[Math.round(Math.random()*(random_list.length-1))];
